<template>
      <g :transform="'translate(' + props.Item.Rect.CX + ',' + props.Item.Rect.CY + ')'">
            <foreignObject :x="props.Item.ColumnSP.X" :y="props.Item.ColumnSP.Y" style="overflow:visible;">
                  ...
                  <n-popselect v-model:value="value" :options="props.Item.StartObj.Columns" size="small" scrollable>
                        <n-button style="margin-right: 8px">
                              {{props.Item.StartObj.TableName}}  {{ value || 'Popselect' }}
                        </n-button>
                  </n-popselect>
            </foreignObject>
            <foreignObject :x="props.Item.ColumnEP.X" :y="props.Item.ColumnEP.Y" style="overflow:visible;">

                  <n-popselect v-model:value="value" :options="props.Item.EndObj.Columns" size="small" scrollable>
                        <n-button style="margin-right: 8px">
                              {{props.Item.EndObj.TableName}}  {{ value || 'Popselect' }}
                        </n-button>
                  </n-popselect>
            </foreignObject>
